...
class TestSimpleCsv(unittest.TestCase):

    '''
    These tests are to demonstrate how to use the 
    csv module for a simple csv (ie no customization)
    '''
    ...
    def test_read_with_reader(self):
        ...
        filename = build_file_path('simple.csv')
    ...
    def test_write_single_rows_with_writer(self):
        ...
        '''
        filename = build_file_path('simple_single_rows_out_with_list.csv')
    ...
    def test_write_multiple_rows_with_writer(self):
        ...
        '''
        filename = build_file_path('simple_all_rows_out_with_list.csv')
    ...
    def test_write_single_rows_with_dictwriter(self):
        ...
        '''
        filename = build_file_path('simple_single_rows_out_with_dict.csv')

        # open the file to write
        with open(filename, 'wb') as f:
            # create the csv writer based upon the open file
            writer = csv.DictWriter(f, ['Name', 'Age', 'Occupation'])
            # write column headers
            writer.writeheader()
            # write one row at a time
            writer.writerow(
    ...
    def test_write_multiple_rows_with_dictwriter(self):
        ...
        The order of the columns is defined on the DictWriter)
        '''
        filename = build_file_path('simple_all_rows_out_with_dict.csv')
